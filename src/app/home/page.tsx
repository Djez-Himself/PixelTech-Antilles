          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-20">
              ...
              <p className="theme-text-secondary text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                Des solutions IT qui vous font gagner du temps, réduisent vos coûts et sécurisent votre activité
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 grid-gap-improved mb-20 max-w-5xl mx-auto">
              <div className="theme-card enhanced-card card-elevated p-10 md:p-12 rounded-2xl border-2 border-primary/20 hover:border-primary/40">
                ...
                <ul className="space-y-3 text-sm md:text-base theme-text-secondary">
